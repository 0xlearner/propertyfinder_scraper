...
class PropertyFinderRent(scrapy.Spider):
    name = "propertyfinder-rent-spider"

    custom_settings = {
        "FEED_FORMAT": "csv",
        "FEED_URI": "propertyfinder-rent.csv",
        "LOG_FILE": "propertyfinder-rent-spider.log",
        # "ITEM_PIPELINES": {
        #     "propertyfinder_eg.pipelines.PropertyFinderRentPipeline": 300
        # },
    }
    ...
    base_url = "https://www.propertyfinder.eg/en/rent/properties-for-rent.html"
