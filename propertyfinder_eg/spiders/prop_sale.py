...
class PropertyFinderSale(scrapy.Spider):
    name = "propertyfinder-sale-spider"

    custom_settings = {
        "FEED_FORMAT": "csv",
        "FEED_URI": "propertyfinder-sale.csv",
        "LOG_FILE": "propertyfinder-sale-spider.log",
        # "ITEM_PIPELINES": {
        #     "propertyfinder_eg.pipelines.PropertyFinderSalePipeline": 300
        # },
    }
